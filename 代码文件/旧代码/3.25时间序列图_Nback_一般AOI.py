...
CONSISTENT_RESIZED = resize_2d_keep_rows(NBACK_1, target_cols=10000)
NONCONSISTENT_RESIZED = resize_2d_keep_rows(NBACK_4, target_cols=10000)
...
for i in range(4):
    # 使用高斯平滑
    smooth_data = gaussian_filter1d(prob_CONSISTENT[i], sigma=10)
